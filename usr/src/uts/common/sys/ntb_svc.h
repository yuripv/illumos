...
typedef struct ntb_driver ntb_driver_t;
typedef struct ntb_drvr_ops ntb_drvr_ops_t;

typedef struct ntb_svc {
	dev_info_t	*dip;
	ntb_driver_t	*drv;
	void		*drv_pvt;
	ntb_drvr_ops_t	*drv_ops;
} ntb_svc_t;
...
extern int	ntb_register(dev_info_t *, ntb_drvr_ops_t *, void *);
...
/*
 * Pass through ntb_drvr_ops routines.
 */
